...
//private static Minterm[] WeightMinterms(MintermCollection masterList, MintermCollection usedList, List<int> toRemove)
//{
//    MintermCollection remainingList = new MintermCollection();

//    foreach (Minterm m in masterList)
//        if (usedList.Contains(m) == false)
//            remainingList.Add(m);

//    Minterm[] final = remainingList.ToArray();
//    Array.Sort(final, new WeightedSort(toRemove));
//    return final;
//}

//private class WeightedSort : IComparer<Minterm>
//{
//    private List<int>       _intRemove;

//    public WeightedSort( List<int> toRemove)
//    {
//        _intRemove = toRemove;
//    }

//    private int GetWeight(Minterm term, List<int> list)
//    {
//        int count = 0;

//        foreach (int i in term.OriginalIntegers)
//            if (list.Contains(i))
//                count++;
...
//    public int Compare(Minterm x, Minterm y)
//    {
//        int xw = GetWeight(x, _intRemove);
//        int yw = GetWeight(y, _intRemove);
